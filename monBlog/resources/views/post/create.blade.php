<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <form action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data" class="mt-10">
            ...
            <x-label for="title" value="Contenu du post" />
            <textarea id="content" name="content"></textarea>

            <x-label for="image" value="Image du post" />
            <x-input id="image" type="file" name="image" />

            <x-label for="category" value="Category du post" />
            ...
            <x-button style="display: block !important;" class="mt-5">Creer mon Post</x-button>
        </form>
